...
<div id="footer" class="clearfix">
	...
	<?php wp_reset_query();if ( is_home()){ ?>
	  ...
	  <?php } ?>
    	...
    	<div class="copyright">
      	<p>   倡萌的自留地为个人站点，本站内容仅供观摩学习交流之用，将不对任何资源负法律责任。<br/>如有侵犯您的版权，请及时联系倡萌（<a href="mailto:admin@cmhello.com">admin@cmhello.com</a>），倡萌将尽快处理。<br/></p>
<p class="powered">Copyright&copy; 2010-2012  <a href="http://www.cmhello.com/" title="倡萌的自留地">CMHELLO.COM</a>.  鄂ICP备09020750号-2  <?php echo stripslashes(get_option('swt_track_code')); ?>  <?php echo get_num_queries(); ?>次查询</p>        
