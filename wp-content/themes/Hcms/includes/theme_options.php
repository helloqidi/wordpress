...
//布局样式设置
	...
	array(	"name" => "<span class='child'>○ CMS首页分栏ID设置</span>",
...
//微博及订阅设置
	...
	array( "type" => "open"),
       ...
       array("name" => "输入twitter微博地址(包含http://)",
            "desc" => "",
	   ...
	   array("name" => "输入腾讯微博地址(包含http://)",
            ...
            "type" => "text",
            "std" => "http://t.qq.com/hcm602"),

       array("name" => "输入新浪微博地址(包含http://)",
            "desc" => "",
            "id" => $shortname."_sinamblog",
            "type" => "text",
            "std" => "http://t.sina.com.cn/hcm602"),
       ...
       array("name" => "输入Feed地址(包含http://)",
            ...
            "type" => "text",
            "std" => "http://feed.feedsky.com/cmhello"),

       array("name" => "输入RSS订阅提示语",
            "desc" => "",
            "id" => $shortname."_rss",
            "type" => "textarea",
            "std" => "Hi! 我是babo，欢迎光临主人的博客，赶快订阅一下吧O(∩_∩)O~"),
...
//广告设置
	...
	array(	"name" => "输入正文右上角广告代码",
            ...
            "id" => $shortname."_adrc",
            "type" => "textarea",
            "std" => '<a href="http://www.cmhello.com/" target="_blank"><img src="http://img.cmhello.com/2012/01/250-250.jpg" alt="Hcms Theme by cmhello.com" /></a>'),
...
add_theme_page($themename." Options", "Hcms主题设置", 'edit_themes', basename(__FILE__), 'mytheme_admin');
}
...
<p>当前使用主题: Hcms |设计者: <a href="http://www.cmhello.com" target="_blank">倡萌</a> | <a href="http://www.cmhello.com/tag/Hcms" target="_blank">查看主题更新</a></p> 
<?php
...
<p>1.首次使用Hcms主题，必须按照您的需要，设置好每个选项，并全都保存一次，否则可能会错位！</p>
<p>2.“布局样式设置”中，首页在【Blog】样式下，如果开启【幻灯】或【最新日志】，底部的 翻页功能 将不能正常使用，这时候，翻页代码不显示。</p>
<p><font color=#ff0000> &hearts; </font><strong>自愿捐助</strong>：Hcms主题目前完全免费，如果能获得些许捐助，倡萌会更有动力去升级完善主题，为您提供更好的技术支持！</p>
<p>支付宝：hcm602@vip.qq.com (捐助前，请务必前往 www.cmhello.com 与倡萌取得联系)</p>
</span>
