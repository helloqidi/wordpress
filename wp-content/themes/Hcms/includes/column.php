...
<div class="con_box fl resouse_artile qd_aritle" id="cat-<?php echo $i; ?>"  >
	...
	<div>	
		...
		<?php while (have_posts()) : the_post(); ?>
			<li class="post-1"> 	
			<cite><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo catch_first_image() ?>" alt="<?php the_title(); ?>"/></a></cite>
			<em><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>" ><?php echo cut_str($post->post_title,28); ?></a></em>
			<br/>
			<em class="excerpt"> <?php echo dm_strimwidth(strip_tags($post->post_content),0,55,"..."); ?></em>
			</li>
		<?php endwhile; ?>
		</ul>
